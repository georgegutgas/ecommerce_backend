...
public class JwtService {
    ...
    // Clave secreta estática de 256 bits codificada en Base64 para mantener la firma consistente tras cada reinicio
    ...
    // Métodos requeridos por JwtAuthenticationFilter:
